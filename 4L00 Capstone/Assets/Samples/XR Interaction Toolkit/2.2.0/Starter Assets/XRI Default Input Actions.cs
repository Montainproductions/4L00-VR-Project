...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""YX"",
                    ""type"": ""Button"",
                    ""id"": ""21502f8a-e6a2-474f-a92e-54246dfd6eda"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""06875493-3786-47d3-813d-d4b97b4ccb3c"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9f61b6bf-6df3-4851-acfd-aae0fde4580f"",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""UIActivation"",
                    ""type"": ""Button"",
                    ""id"": ""f47ccafd-64cd-4215-9609-79f70c35aa6f"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""8758b9b6-418c-41cb-9abd-f6f2c4b36682"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c49a23d1-14ff-4c16-bdae-ad1acd52a862"",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Open"",
                    ""type"": ""Button"",
                    ""id"": ""cb8c0f8a-c47a-4113-9896-be746950f262"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""ded2099e-1608-486d-bb8d-d0522f397643"",
                    ""path"": ""<XRController>{LeftHand}/menu"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHandInteraction_YX = m_XRILeftHandInteraction.FindAction("YX", throwIfNotFound: true);
        ...
        m_XRIRightHandInteraction_UIActivation = m_XRIRightHandInteraction.FindAction("UIActivation", throwIfNotFound: true);
        ...
        m_XRIUI_Open = m_XRIUI.FindAction("Open", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_XRILeftHandInteraction_YX;
    public struct XRILeftHandInteractionActions
    {
        ...
        public InputAction @YX => m_Wrapper.m_XRILeftHandInteraction_YX;
        ...
        public void SetCallbacks(IXRILeftHandInteractionActions instance)
        {
            if (m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface != null)
            {
                ...
                @YX.started -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnYX;
                @YX.performed -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnYX;
                @YX.canceled -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnYX;
            }
            ...
            if (instance != null)
            {
                ...
                @YX.started += instance.OnYX;
                @YX.performed += instance.OnYX;
                @YX.canceled += instance.OnYX;
            }
        }
    }
    ...
    private readonly InputAction m_XRIRightHandInteraction_UIActivation;
    public struct XRIRightHandInteractionActions
    {
        ...
        public InputAction @UIActivation => m_Wrapper.m_XRIRightHandInteraction_UIActivation;
        ...
        public void SetCallbacks(IXRIRightHandInteractionActions instance)
        {
            if (m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface != null)
            {
                ...
                @UIActivation.started -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnUIActivation;
                @UIActivation.performed -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnUIActivation;
                @UIActivation.canceled -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnUIActivation;
            }
            ...
            if (instance != null)
            {
                ...
                @TranslateAnchor.performed += instance.OnTranslateAnchor;
                @TranslateAnchor.canceled += instance.OnTranslateAnchor;
                @UIActivation.started += instance.OnUIActivation;
                @UIActivation.performed += instance.OnUIActivation;
                @UIActivation.canceled += instance.OnUIActivation;
            }
        }
    }
    ...
    private readonly InputAction m_XRIUI_Open;
    public struct XRIUIActions
    {
        ...
        public InputAction @Open => m_Wrapper.m_XRIUI_Open;
        ...
        public void SetCallbacks(IXRIUIActions instance)
        {
            if (m_Wrapper.m_XRIUIActionsCallbackInterface != null)
            {
                ...
                @Open.started -= m_Wrapper.m_XRIUIActionsCallbackInterface.OnOpen;
                @Open.performed -= m_Wrapper.m_XRIUIActionsCallbackInterface.OnOpen;
                @Open.canceled -= m_Wrapper.m_XRIUIActionsCallbackInterface.OnOpen;
            }
    ...
    public interface IXRILeftHandInteractionActions
    {
        ...
        void OnYX(InputAction.CallbackContext context);
    }
    ...
    public interface IXRIRightHandInteractionActions
    {
        ...
        void OnRotateAnchor(InputAction.CallbackContext context);
        void OnTranslateAnchor(InputAction.CallbackContext context);
        void OnUIActivation(InputAction.CallbackContext context);
    }
